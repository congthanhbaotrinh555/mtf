$(document).ready(function() {
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Searching for PID <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> ...");	
					progressBarConsole(18, $('#progressBarConsole'));			
				}, 3000 );
				setTimeout(function() { 
					$console_message.html("Connecting to PID <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> on <span class='console-message-connected-item'>" + $console_message_platform_msg + "</span> Platform");	
				...
				//-------------------------------1 Resurs Start-------------------------------//
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> MARVEL Strike Force Gold");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut1_msg + "</span> <span class='console-message-success'>MARVEL Strike Force Gold Generated Successfully</span>");
				...
				setTimeout(function() { 
					$console_message.html("Generating Packets for Power Cores");	
				...
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> MARVEL Strike Force Power Cores");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_fut2_msg + "</span> <span class='console-message-success'>MARVEL Strike Force Power Cores Generated Successfully</span>");
	...
	$('#second-step-button').click(function() {
		if ($('#account-username').val() != '') {
			...
			swal("Error", "Please enter your PID.", "error");
		}
	});
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit fut Power Cores generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Power Cores and points for himself haha');
